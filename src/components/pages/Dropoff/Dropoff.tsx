...
const Dropoff = () => {
  const [dropoffSelected, setDropoffSelected] = useState<boolean>(false);
  return (
    <View style={pageComponentViewstyles.lineStyle}>
      ...
      >
        {/* {dropoffSelected == false ? (
          <TouchableOpacity
            onPress={() => setDropoffSelected(!dropoffSelected)}>
            <Text style={pageComponentViewstyles.pageComponentText}>Dropoff</Text>
          ...
          <View>
            <TouchableOpacity
              onPress={() => setDropoffSelected(!dropoffSelected)}>
              <Text style={pageComponentViewstyles.selectedText}>Dropoff</Text>

            </TouchableOpacity>
            <View style={pickupSelectedStyle.PickupContainer}>
              <Text style={pickupSelectedStyle.PickupText}>Select dropoff date and time</Text>
            </View>
